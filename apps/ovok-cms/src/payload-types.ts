...
export interface ContentType {
  ...
  name: string;
  /**
   * Plural form, e.g. "Landing Contents". Used in list headings.
   */
  pluralName: string;
  /**
  ...
  fields?:
    | {
        ...
        key: string;
        label: string;
        type: 'text' | 'textarea' | 'richtext' | 'number' | 'checkbox' | 'date' | 'select' | 'media' | 'relationship';
        required?: boolean | null;
        unique?: boolean | null;
        hasMany?: boolean | null;
        description?: string | null;
        /**
         * Slug of the target content type (for relationship fields).
         */
...
export interface ContentItem {
  ...
  title: string;
  /**
   * Optional URL-safe identifier. Unique per content-type per tenant when set.
   */
  slug?: string | null;
